        ...
        <div className="p-8 sm:p-12">
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <div className="relative mb-8">
              <div className="w-32 h-48 sm:w-40 sm:h-56 rounded-[2rem] border-4 border-dashed border-gray-200 p-3 flex items-center justify-center">
            ...
            <h2 className="text-xl font-bold text-gray-800 mb-2">欢迎使用电量查询</h2>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-6">
              <span className="px-3 py-1.5 rounded-full bg-gray-100 text-xs text-gray-500 flex items-center gap-1">
